        ...
        <div className=" bg-white rounded-[5px] h-[60rem] max-sm:h-[53rem] px-8 pt-5 mt-5">
          ...
          <form className="w-[60%] max-md:w-[80%] max-sm:w-full justify-between items-center flex flex-wrap my-5 mt-10 ">
            <div className="text-gray-900 text-base max-sm:text-xs font-normal w-[45%] mb-5">
              ...
              <input
                className="w-full p-2 px-1 rounded-[5px] border border-neutral-300 opacity-40 text-zinc-700 text-sm max-sm:text-xs font-normal"
            ...
            <div className="text-gray-900 text-base max-sm:text-xs font-normal w-[45%] mb-5">
              <label>Cost</label>
              <input
                className="w-full p-2 rounded-[5px] border border-neutral-300 opacity-40 text-zinc-700 text-sm max-sm:text-xs font-normal"
                placeholder="$"
              />
            </div>
            <div className="text-gray-900 text-base max-sm:text-xs font-normal w-[45%] mb-5">
            ...
            <div className="w-[45%] p-2 rounded-[5px] border border-neutral-300  items-center flex">
              ...
              <div className="text-zinc-800 text-xs max-lg:text-[10px] max-sm:text-[6px] font-normal">
                Upload Attachments
              </div>
            </div>
            ...
            <div className="text-gray-900 text-base max-sm:text-xs font-normal w-full mb-5">
              ...
              <textarea
                rows="4"
                className="resize-none rounded-[5px] border border-neutral-300 opacity-40 p-2 w-full flex justify-between items-center text-zinc-700 text-sm max-sm:text-xs font-normal"
