  ...
  return (
    <div className='w-full min-h-screen max-sm:h-full max-sm:pb-5 flex bg-[#F5F5F5]'>
      ...
      <div className=' w-[86%] lg:w-[72%] xl:w-[78%] max-md:w-full mx-6  max-md:mx-0 h-full ml-auto'>
        ...
        <div className='flex w-full mt-3 h-[24rem] max-sm:h-[44rem] justify-between max-md:px-3 max-xl:mt-5 max-sm:flex-col '>
            ...
            <div className="shadow bg-white flex w-full rounded-md pb-4 h-5/8 max-xl:h-7/10 max-sm:w-full max-sm:h-3/4 max-sm:my-3">
              <div className='w-1/4 max-lg:w-1/6 flex justify-center pt-3'>
                <div className='rounded-full p-4 max-lg:p-2 bg-blue-100 self-start'>
                  <img src={googleIcon} alt="icon" className='max-lg:w-6 max-lg:h-6' />
                </div>
              </div>
              <div className="flex flex-col items-start justify-between  w-3/4 max-lg:w-5/6 max-xl:pt-2 max-lg:pt-1 pr-2">
                ...
                <div className="flex items-center justify-around  mb-5 max-lg:mb-2 w-full max-sm:text-[10px]">

                  <div className="text-xs max-sm:text-[10px] font-['Montserrat'] text-[#323232] mt-px mb-1">
                    London
                  </div>
                  <div className="text-xs max-sm:text-[10px] font-['Montserrat'] text-[#323232] mr-2">
                    $20k Hourly
                  </div>
                  <div className="text-xs max-sm:text-[10px] font-['Montserrat'] text-[#323232] mr-3">
                    3 Days left
                  </div>
                  <div className="text-xs max-sm:text-[10px] font-['Montserrat'] text-[#323232]">
                    Remote
                  </div>
                </div>
