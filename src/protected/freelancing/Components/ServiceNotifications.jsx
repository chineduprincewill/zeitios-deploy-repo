    ...
    return (
        <div className=" h-full flex flex-col justify-center  ">
            <div className='flex justify-between items-center px-6 max-md:px-1 py-3 '>
                <div className=" text-zinc-700 text-base font-normal w-1/2 max-sm:w-[60%]  flex justify-start max-md:text-xs max-sm:text-[8px] max-sm:mr-[2px]">
                ...
                <div className=" text-zinc-700 text-base font-normal w-1/5 max-lg:w-1/4  flex justify-center max-md:text-xs max-sm:text-[8px]">$20k-$30k Hourly</div>
