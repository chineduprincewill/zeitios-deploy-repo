...
const Header = () => {
    ...
    const { user, userid, shownav, updateShownav, logout } = useContext(AuthContext);
    ...
    return (
        <div className='fixed top-0 z-30 w-full flex justify-between items-center m-0 px-4 py-4 bg-[#0259dc]'>
            ...
            <div className='md:flex hidden'>
                ...
                <input type='text' className='w-[300px] bg-gray-200 rounded-r-xl p-1' placeholder='Search' />
            </div>
