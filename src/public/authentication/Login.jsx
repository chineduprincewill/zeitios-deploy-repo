...
const Login = () => {
    ...
    if(success !== null){
        ...
        localStorage.setItem('userInfo', success.ChallengeParameters.userAttributes);
        navigate('/dashboard');
        location.reload();
    }
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div className='mt-12'>
                            ...
                            <p className='flex justify-center text-sm text-[#0259dc] bg-gray-100 my-4 py-3'>
                                <span>Didn't receive email on sign up? Click <Link to="/resend-code"><strong>here</strong></Link> for SMS</span>
                            </p>
                        </div>
                    </form>
                </div>
